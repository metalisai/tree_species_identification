...
train_ds() {
	...
	python train_param.py --aug --dataset_dir $DATASET_DIR --epochs $2 --batch_size $BATCH_SIZE --grad_accum_steps $ACCUM_STEPS --output_dir "train_output_${1}_fine_a"
	...
	python train_param.py --aug --dataset_dir $DATASET_DIR --epochs $2 --batch_size $BATCH_SIZE --grad_accum_steps $ACCUM_STEPS --output_dir "train_output_${1}_medium_a"
	...
	python train_param.py --aug --dataset_dir $DATASET_DIR --epochs $2 --batch_size $BATCH_SIZE --grad_accum_steps $ACCUM_STEPS --output_dir "train_output_${1}_coarse_a"
}
